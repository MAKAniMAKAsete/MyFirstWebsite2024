...
const jsonContentData = [
    ...
    {"title": "Qué es JS", "content": "    JS, o JavaScript, es un lenguaje de programación interpretado. Se define como orientado a objetos, basado en prototipos, imperativo, débilmente tipado y dinámico. Se utiliza principalmente del lado del cliente, implementado como parte de un navegador web permitiendo mejoras en la interfaz de usuario y páginas web dinámicas. Java y JavaScript tienen semánticas y propósitos diferentes."}
];
